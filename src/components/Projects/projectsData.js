import roomieLandingPage from '../../images/roomieLandingPage.png'
import craigPortfolio from '../../images/craigPortfolio.png'
import helpingHands from '../../images/helpingHands.png'
import WalkLand from '../../images/WalkLand.png'


const projectsData = [
    {
      id: Math.round(Math.random() * 100),
      img: roomieLandingPage,
      title: 'rOOmie',
